      ...
      if (record.lines?.length) {
        ...
        if (record.groups?.length) {
          reconstructed.forEach((g, idx) => {
            ...
            if (saved?.wizard_cost_ceil_w_custom_mm != null) g.wizard_cost_ceil_w_custom_mm = saved.wizard_cost_ceil_w_custom_mm
            if (saved?.wizard_cost_ceil_h_custom_mm != null) g.wizard_cost_ceil_h_custom_mm = saved.wizard_cost_ceil_h_custom_mm
    ...
    setGroups(prev => prev.map(g => {
      ...
      const sizes = g.sizes.map((s, i) => {
        ...
        return {
          ...
          _cep_cost_manual: r._cep_cost_manual || false,
  ...
  const openComparisonWizard = (group) => {
    ...
    const rows = group.sizes.map((s, i) => {
      ...
      return {
        ...
        glass_cost,
        cep_cost,
        _cep_cost_manual: s._cep_cost_manual || false,
        proc_cost,
        selling_amount,
        cost_amount,
        margin_amount,
