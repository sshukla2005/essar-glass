            ...
            <Table
              ...
              columns={[
                ...
                },
                {
                  ...
                  render: (v, row) => <InputNumber size="small" value={v ? parseFloat(v.toFixed(3)) : null} min={0} style={{ width: '100%' }}
                    onChange={val => setGroups(prev => prev.map(g => {
                      ...
                      return {
                        ...g, sizes: g.sizes.map(s => {
                          ...
                          const ncs = val && s.charged_h_inch ? parseFloat(((val * s.charged_h_inch * s.quantity) / 144).toFixed(4)) : s.charged_sqft
                  ...
                  render: (v, row) => <InputNumber size="small" value={v ? parseFloat(v.toFixed(3)) : null} min={0} style={{ width: '100%' }}
                    onChange={val => setGroups(prev => prev.map(g => {
                      ...
                      return {
                        ...g, sizes: g.sizes.map(s => {
                          if (s.size_key !== row.size_key) return s
                          const ncs = val && s.charged_w_inch ? parseFloat(((s.charged_w_inch * val * s.quantity) / 144).toFixed(4)) : s.charged_sqft
