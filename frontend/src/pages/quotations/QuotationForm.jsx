...
const QuotationForm = () => {
  ...
  const openComparisonWizard = (group) => {
    ...
    const totalSelling = rows.reduce((s, r) => s + r.selling_amount, 0)
        ...
        {groups.map(group => (
          ...
          >
            ...
            <Row gutter={8} align="middle" style={{ marginBottom: 8 }}>
              ...
              <Col flex="130px">
                <Text style={{ fontSize: 10, color: '#94a3b8', display: 'block', marginBottom: 2 }}>CEILING</Text>
              ...
              <div style={{ marginTop: 20 }}>
                ...
                <Table
                  ...
                  columns={[
                    {
                      ...
                      render: t => <Tag color={t === 'Hardware' ? 'blue' : 'orange'}>{t}</Tag>
                    },
                    { title: 'Description', dataIndex: 'description' },
                    { title: 'Qty', dataIndex: 'qty', width: 60, align: 'right' },
                  ...
                  summary={() => {
                    ...
                    const totalHwLbSell = hwSell + lbSell
                    const totalHwLbCost = hwCost + lbCost
                    ...
                    return (
                      <Table.Summary.Row style={{ background: '#f8fafc', fontWeight: 600 }}>
                        <Table.Summary.Cell colSpan={6}>
                          <Text strong>HW + Labor Subtotal</Text>
                        </Table.Summary.Cell>
                        <Table.Summary.Cell align="right">
                          <Text strong style={{ color: '#dc2626' }}>
                ...
                <div style={{
                  ...
                  {(() => {
                    ...
                    const lbSell = laborItems.reduce((s, l) => s + (l.amount || 0), 0)
                    const lbCost = laborItems.reduce((s, l) => s + (l.cost_amount || (l.qty||0)*(l.cost_rate||0)), 0)
                    const trueSell = globalComparison.totalSelling + hwSell + lbSell
                    const trueCost = globalComparison.totalCost + hwCost + lbCost
